...
<html>
	...
	-->
		...
		<script type='text/javascript' src='dwr/interface/DataBaseService.js'></script>
		...
		<script type="text/javascript">
  		...
  		function insertUser(){
  			...
  			DataBaseService.insert(userdata, function (value){
  				alert(value);
  			});
  		}
  		...
  		function findUser(){
  			...
  			DataBaseService.find(id, function (u){
  				//for(var i in u){
  				//	alert(i);
  				//}
  				alert(u.id);
